...
{
    // TODO: The final field should be a union of architecture-specific details
    // Placeholder size is a constant found in memory (the cs_malloc call stack)

    [StructLayout(LayoutKind.Explicit)]
    public unsafe struct NativeArchitectureDetails
    {
        [FieldOffset(0)]
        public NativeX86InstructionDetail X86;
    }

    // Placeholder size is a constant found in memory (the cs_malloc call stack)
    [StructLayout(LayoutKind.Sequential, Size=1528)]
    public unsafe struct NativeInstructionDetail
    {
        /// <summary>
